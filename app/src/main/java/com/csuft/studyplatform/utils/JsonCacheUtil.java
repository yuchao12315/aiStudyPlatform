...
import com.csuft.studyplatform.model.domain.CacheWithDuration;
...
public class JsonCacheUtil {
    ...
    private JsonCacheUtil() {
        mSharedPreferences = BaseApplication.getBaseApplication().getSharedPreferences(JSON_CACHE_SP_NAME,Context.MODE_PRIVATE);
        mGson = new Gson();
    }
