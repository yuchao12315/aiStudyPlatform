package com.csuft.studyplatform.ui.custom;
...
import com.csuft.studyplatform.utils.DisplayMetricsUtil;
...
public class TitleView extends FrameLayout {
	...
	public void setLeftButtonAsFinishWhite(final Activity a) {
		showView(0, 0);
		mLeftText.setText("\ue60c");
		mLeftText.setTextColor(a.getResources().getColor(R.color.white));
		setLeftButtonOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				a.finish();
