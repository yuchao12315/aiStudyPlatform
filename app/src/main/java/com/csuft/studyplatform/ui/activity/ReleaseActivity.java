...
import com.csuft.studyplatform.SendSmallVideoActivity;
...
import com.csuft.studyplatform.ui.adapter.ImagePickerAdapter;
 ...
 * 发布信息专用的Activity
 */
public class ReleaseActivity extends BaseActivity implements ImagePickerAdapter.OnRecyclerViewItemClickListener {
    ...
    private void bindView() {
        ...
        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.release_recycler);
         GridLayoutManager mGridLayoutManager = new GridLayoutManager(getBaseContext(),4);
                        ...
                        .itemsCallback(new ListCallback() {
                            ...
                            public void onSelection(MaterialDialog dialog, View itemView, int position, CharSequence text) {
                                if (text.equals("相片")){
                                    ...
                                    BaseApplication.initSmallVideo(ReleaseActivity.this.getApplicationContext());
